...
|--------|---------|------------|----------|-------|
| WSPR (`wspr.bronze`) | 12.59B | 93.6M | Measured (-30 to +20 dB) | 2008–2026 |
...
| PSK Reporter (`pskr.bronze`) | 6.63B (26M/day) | Pending | Measured (-34 to +38 dB) | Feb 2026+ |
