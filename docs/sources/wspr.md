...
**12.69B spots. 18 years. One of the largest amateur radio propagation
...
| Metric | Value |
|--------|-------|
| **Total Rows (`wspr.bronze`)** | 12.69B |
| **Date Range** | 2008-03-11 to 2026-09-23 |
| **Daily Spot Rate (recent)** | ~7M spots/day |
| **Unique Transmitter Callsigns** | 4.6M |
| **Unique Receiver Callsigns** | 103,057 |
