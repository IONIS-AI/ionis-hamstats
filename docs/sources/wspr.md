...
**11.07B spots. 18 years. One of the largest amateur radio propagation
...
| Metric | Value |
|--------|-------|
| **Total Rows (`wspr.bronze`)** | 11.07B |
| **Date Range** | 2008-03-11 to 2026-03-12 |
| **Daily Spot Rate (recent)** | ~7M spots/day |
| **Unique Transmitter Callsigns** | 3.7M |
| **Unique Receiver Callsigns** | 99,618 |
